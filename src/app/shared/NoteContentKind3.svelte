...
<FlexColumn small>
  <div
    ...
    <div class="mb-4 border-l-2 border-solid border-nc-shell-border pl-4 text-lg">
      Updated follow list:
    </div>
    <div>
      {#each take(limit, getPubkeyTagValues(note.tags)) as pubkey}
        <div class="inline-block rounded-full px-3 py-2 transition-colors hover:bg-nc-shell-bg">
